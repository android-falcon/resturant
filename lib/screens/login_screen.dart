...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    super.initState();
    if(UMNIA_FALG==1){
      ColorsApp.orange_2=Color(0xFFDCE324);
      ColorsApp.orange_light=Color(0xFFededd9);
      ColorsApp.black=Color(0xFF343c4b);
      ColorsApp.red_light=Color(0xFF343c4b);
    }
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image:UMNIA_FALG==1?AssetImage('assets/images/rectangle602.png'): AssetImage('assets/images/rectangle60.png'),
                    fit: BoxFit.fill
                  ),
            ...
            Expanded(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                        image: UMNIA_FALG==1? AssetImage( 'assets/images/login_back_umnia.png'):AssetImage( 'assets/images/home_back.png'),
                        fit: BoxFit.fill
                    ),
                ...
                child: Column(
                  ...
                  Center(
                    child: Container(
                      ...
                      // padding: EdgeInsets.only(bottom: 10,left: 10,right: 5,top:60),
  ...
  void changePrimary() {
    ColorsApp.accentColor = MaterialColor(
      0xFFDCE324,
        <int, Color>{
        50: Color(0xFFDCE324),
