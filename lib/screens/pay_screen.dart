...
class _PayScreenState extends State<PayScreen> {
            ...
            Row(
              ...
              children: [
                CustomButton(
                  backgroundColor: ColorsApp.orange_2,
                  fixed: true,
                  child: Text('Print'.tr,style: TextStyle(color: ColorsApp.backgroundDialog),),
                  onPressed: () {
                    Printer.invoices(invoices: invoices);
                  },
                ),
                ...
                CustomButton(
                  backgroundColor: ColorsApp.red_light,
                  fixed: true,
                  child: Text('Close'.tr,style: TextStyle(color: ColorsApp.backgroundDialog),),
                  onPressed: () {
                    Get.back();
                  },
                ),
  ...
  Future<void> openCashDialog()async{
