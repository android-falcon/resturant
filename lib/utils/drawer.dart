...
import 'enums/enum_in_out_type.dart';
...
class AppDrawerState extends State<AppDrawer> {
              ...
              Get.defaultDialog(
                ...
                content: Column(
                  children: [
                    ...
                    Text(
                        '${'Daily Close Date'.tr} : ${DateFormat('yyyy-MM-dd').format(mySharedPreferences.dailyClose)}'),
                    Text(
                        '${'New Daily Close Date'.tr} : ${DateFormat('yyyy-MM-dd').format(mySharedPreferences.dailyClose.add(const Duration(days: 1)))}'),
                  ],
                ),
                ...
                onConfirm: () async {
                  await RestApi.posDailyClose(
                      closeDate: mySharedPreferences.dailyClose
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                        image:UMNIA_FALG==1?AssetImage('assets/images/logo_arabic.png'): AssetImage('assets/images/rectangle60.png'),
                        fit: BoxFit.contain
                    ),
  ...
  _showInOutDialog({required InOutType type}) async {
    var indexPrinter = allDataModel.printers
        .indexWhere((element) => element.cashNo == mySharedPreferences.cashNo);
    PrinterImageModel? _printer;
    if (indexPrinter != -1) {
      _printer = PrinterImageModel(
          ipAddress: allDataModel.printers[indexPrinter].ipAddress,
          port: allDataModel.printers[indexPrinter].port);
    }
    ...
    bool result = await Get.dialog(
      CustomDialog(
        ...
        builder: (context, setState, constraints) {
          moneyCount = MoneyCount.moneyCount.fold(
              0.0,
              (previousValue, element) =>
                  (previousValue) +
                  ((element.value * element.rate) *
                      double.parse(element.qty.text)));
          return Column(
            children: [
              Row(
                children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      textAlign: TextAlign.center,
                                      style: kStyleTextDefault.copyWith(
                                          color: ColorsApp.red),
                                    ),
                                  ],
                                ),
                                      ...
                                      children: [
                                        Expanded(
                                          ...
                                          child: InkWell(
                                            onTap: () {
                                              setState(() {
                                                MoneyCount.moneyCount[index].qty
                                                        .text =
                                                    '${int.parse(MoneyCount.moneyCount[index].qty.text) + 1}';
                                              });
                                            },
                                            child: Padding(
                                        ...
                                        Expanded(
                                          child: CustomTextFieldNum(
                                            enableInteractiveSelection: false,
                                            controller: MoneyCount
                                                .moneyCount[index].qty,
                                            fillColor: _controllerSelectEdit ==
                                                    MoneyCount
                                                        .moneyCount[index].qty
                                            ...
                                            onTap: () {
                                              FocusScope.of(context)
                                                  .requestFocus(FocusNode());
                                              _controllerSelectEdit = MoneyCount
                                                  .moneyCount[index].qty;
                                              setState(() {});
                                            },
                                          ),
                                        ...
                                        Expanded(
                                          child: Text(
                                            ((MoneyCount.moneyCount[index]
                                                            .value *
                                                        MoneyCount
                                                            .moneyCount[index]
                                                            .rate) *
                                                    double.parse(MoneyCount
                                                        .moneyCount[index]
                                                        .qty
                                                        .text))
                                                .toStringAsFixed(3),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: numPadWidget(
                          ...
                          onExit: () async {
                            var result =
                                await showAreYouSureDialog(title: 'Exit'.tr);
                            if (result) {
                          ...
                          onSubmit: () async {
                            var result =
                                await showAreYouSureDialog(title: 'Save'.tr);
                            if (result) {
                              if (_typeInputCash == 1
                                  ? double.parse(_controllerManual.text) > 0
                                  : moneyCount > 0) {
                                switch (type) {
                                  case InOutType.payIn:
                                    RestApi.payInOut(
                                      value: _typeInputCash == 1
                                          ? double.parse(_controllerManual.text)
                                          : moneyCount,
    ...
    if (_printer != null && result) {
      ...
      Future.delayed(const Duration(milliseconds: 100)).then((value) async {
        var screenshot = await _screenshotController.capture(
  ...
  _showEndCashDialog({required EndCashModel endCash}) async {
    ...
    GlobalKey<FormState> _keyForm = GlobalKey<FormState>();
    TextEditingController _controllerTotalCash =
        TextEditingController(text: '0');
    TextEditingController _controllerTotalCreditCard =
        TextEditingController(text: '0');
    TextEditingController _controllerTotalCredit =
        TextEditingController(text: '0');
    TextEditingController _controllerNetTotal =
        TextEditingController(text: '0');
    ...
    var result = await Get.dialog(
      CustomDialog(
        ...
        builder: (context, setState, constraints) {
          double netTotal = double.parse(_controllerTotalCash.text) +
              double.parse(_controllerTotalCreditCard.text) +
              double.parse(_controllerTotalCredit.text);
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Padding(
                                padding: EdgeInsets.only(bottom: 5,left: 5,right: 5,top: 5),
                                child:  Text('Total Credit Card'.tr
                                  ,textAlign:TextAlign.right,
                                  style: kStyleHint.copyWith(fontWeight: FontWeight.bold),
                          ...
                          onSubmit: () async {
                            ...
                            if (result) {
                              var resultEndCash = await RestApi.endCash(
                                totalCash:
                                    double.parse(_controllerTotalCash.text),
                                totalCreditCard: double.parse(
                                    _controllerTotalCreditCard.text),
                                totalCredit:
                                    double.parse(_controllerTotalCredit.text),
                                netTotal:
                                    double.parse(_controllerNetTotal.text),
                              );
                              if (resultEndCash) {
                                Get.back(result: true);
                              }
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: CustomButton(
                                  ...
                                  onPressed: () async {
                                    FocusScope.of(context).requestFocus(FocusNode());
                                    _reprintModel = await RestApi.getInvoice(
                                        invNo: int.parse(_controllerVoucherNumber.text));
                                    _reprintModel = calculateOrder(
                                        cart: _reprintModel!,
                                        orderType: _reprintModel!.orderType,
                                        invoiceKind: InvoiceKind.invoicePay);
                                    setState(() {});
                                  },
                                ),
                              ),
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  decoration:BoxDecoration(
                                      ...
                                      border: Border.all(color: ColorsApp.gray_light)
                                  ),
                                  child: Text(
                                    _reprintModel == null
                                        ? ''
                      ...
                      Center(
                        child: Column(
                          children: [
                            ...
                            Text(
                              _reprintModel!.orderType == OrderType.takeAway
                                  ? 'Take Away'.tr
                                  : 'Dine In'.tr,
                              style: kStyleLargePrinter,
                            ),
                      ...
                      Column(
                        children: [
                          ...
                          ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              if (_reprintModel!
                                  .items[index].parentUuid.isNotEmpty) {
                                return Container();
                              } else {
                                var subItem = _reprintModel!.items
                                    .where((element) =>
                                        element.parentUuid ==
                                        _reprintModel!.items[index].uuid)
                                    .toList();
                                return Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              _reprintModel!.items[index].total
                                                  .toStringAsFixed(3),
                                              style: kStyleDataPrinter,
                                              textAlign: TextAlign.center,
                                            ),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  _reprintModel!.totalLineDiscount
                                      .toStringAsFixed(3),
                                  style: kStyleDataPrinter.copyWith(
                                      fontWeight: FontWeight.bold),
                                ),
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: Text(
                                    'Amount Due'.tr,
                                    style: kStyleTitlePrinter.copyWith(
                                        fontWeight: FontWeight.bold),
                                  ),
                                ),
                                Text(
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomButton(
                            ...
                            onPressed: () async {
                              FocusScope.of(context).requestFocus(FocusNode());
                              _refundModel = await RestApi.getRefundInvoice(
                                  invNo: int.parse(_controllerVoucherNumber.text));
                              _refundModel = calculateOrder(
                                  cart: _refundModel!,
                                  orderType: _refundModel!.orderType,
                                  invoiceKind: InvoiceKind.invoiceReturn);
                              setState(() {});
                            },
                          ),
                        ],
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 7.h,),
                  const Divider(color: ColorsApp.gray_light, height: 1),
                  if (_refundModel != null)
                    ListView.separated(
                      ...
                      physics: const NeverScrollableScrollPhysics(),
                      separatorBuilder: (context, index) =>
                          _refundModel!.items[index].parentUuid.isNotEmpty
                              ? Container()
                      ...
                      itemBuilder: (context, index) {
                        if (_refundModel!.items[index].parentUuid.isNotEmpty) {
                          ...
                          var subItem = _refundModel!.items
                              .where((element) =>
                                  element.parentUuid.isNotEmpty &&
                                  element.parentUuid ==
                                      _refundModel!.items[index].uuid)
                              .toList();
                          return Column(
                            children: [
                              Padding(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          _refundModel!
                                                  .items[index].returnedQty =
                                              await _showQtyDialog(
                                                  rQty: _refundModel!
                                                      .items[index].returnedQty,
                                                  maxQty: _refundModel!
                                                      .items[index].qty);
                                          for (var element in subItem) {
                                            element.returnedQty = _refundModel!
                                                .items[index].returnedQty;
                                          }
                                          _refundModel = calculateOrder(
                                              cart: _refundModel!,
                                              orderType:
                                                  _refundModel!.orderType,
                                              invoiceKind:
                                                  InvoiceKind.invoiceReturn);
                                          setState(() {});
                                        },
                                        child: Row(
                                          mainAxisAlignment:
                ...
                Expanded(
                  child: CustomButton(
                    ...
                    onPressed: _refundModel == null
                        ...
                        : () async {
                            var result =
                                await showAreYouSureDialog(title: 'Refund'.tr);
                            if (result) {
                              if (_refundModel!.items
                                  .any((element) => element.returnedQty > 0)) {
                                _refundModel!.items.removeWhere(
                                    (element) => element.returnedQty == 0);
                                RestApi.invoice(
                                    cart: _refundModel!,
                                    invoiceKind: InvoiceKind.invoiceReturn);
                                RestApi.returnInvoiceQty(
                                    invNo: int.parse(
                                        _controllerVoucherNumber.text),
  ...
  Future<double> _showQtyDialog(
      {TextEditingController? controller,
      double? maxQty,
      double minQty = 0,
      required double rQty}) async {
    GlobalKey<FormState> _keyForm = GlobalKey<FormState>();
  ...
  getIcon(int index) {
    switch(index){
      case 0:
       return Icon(Icons.money, color: ColorsApp.orange_2) ;
      case 1:
        return Icon(Icons.monetization_on_outlined, color: ColorsApp.gray) ;
      case 2:
        return Icon(Icons.pin_end_rounded, color: ColorsApp.gray) ;
      case 3:
        return Icon(Icons.receipt_long, color: ColorsApp.gray) ;
      case 4:
        return Icon(Icons.print, color: ColorsApp.gray) ;
      case 5:
        return Icon(Icons.cable_sharp, color: ColorsApp.gray) ;
      case 6:
        return Icon(Icons.checklist_rtl, color: ColorsApp.gray) ;
      case 7:
        return Icon(Icons.clear, color: ColorsApp.gray) ;
      case 8:
        return Icon(Icons.refresh, color: ColorsApp.gray) ;
      case 9:
        return Icon(Icons.logout_outlined, color: ColorsApp.gray) ;
    }
