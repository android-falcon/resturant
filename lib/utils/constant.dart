...
import 'package:restaurant_system/utils/color.dart';
 ...
 var kStyleTextDefault = TextStyle(fontWeight: FontWeight.normal, fontSize: 14.sp);
final kStyleTextOrange = TextStyle(fontWeight: FontWeight.normal, fontSize: 14.sp,color: ColorsApp.orange_2);

final kStyleTextTitle = TextStyle(fontWeight: FontWeight.normal, fontSize: 17.sp);
final kStyleHeaderTable = TextStyle(fontWeight: FontWeight.bold, fontSize: 13.sp, color: Colors.black);
